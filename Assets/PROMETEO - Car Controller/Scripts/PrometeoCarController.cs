...
public class PrometeoCarController : NetworkBehaviour
{
    ...
    public override void OnNetworkSpawn()
    {
        ...
        name += $"{NetworkManager.LocalClientId}";
    }
    ...
    private void RandomizeSpawnPoint_ServerRpc(ServerRpcParams serverRpcParams = default)
    {
        ...
        Transform spawn = allSpawns[UnityEngine.Random.Range(0, allSpawns.Length)].transform;
    ...
    {
        GameObject prefab = Resources.Load("FreeLookCamera") as GameObject;
